<main>
                                ...
                                <form wire:submit.prevent="submit" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="subscription_type" wire:model.defer="subscription_type"
                                            class="form-select @error('subscription_type') is-invalid @enderror"
                                            required>
    ...
    @if ($showPopup && is_array($popupData) && !empty($popupData))
        <div class="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
            ...
            <div class="bg-white rounded shadow p-4" style="max-width: 500px; width: 100%; position: relative;">
                <button class="btn-close position-absolute top-0 end-0 m-3" wire:click="$set('showPopup', false)"></button>
    ...
    {{-- Popup jika nama sudah digunakan --}}
    @if ($namaSudahAda)
        <div class="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center"
            style="background: rgba(0,0,0,0.6); z-index: 10000;">
            <div class="bg-white p-4 rounded shadow" style="max-width: 400px; width: 100%;">
                <h5 class="text-danger text-center mb-3">Nama sudah digunakan</h5>
                <p class="text-center">Silakan gunakan nama lain yang belum terdaftar di sistem.</p>
                <div class="d-flex justify-content-center mt-3">
                    <button class="btn btn-danger" wire:click="$set('namaSudahAda', false)">Ubah Nama</button>
                </div>
            </div>
        </div>
    @endif
