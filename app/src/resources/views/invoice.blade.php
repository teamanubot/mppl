        ...
        <div class="invoice-box">
            <div class="invoice-header">
                <div>
                    ...
                    @endphp
                    <small class="text-muted">Tanggal Cetak: {{ $tanggalCetak }} WIB</small>
                </div>
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th><i class="fas fa-star icon"></i>Order ID</th>
                        <td>{{ ucfirst($status->paymentTransaction->midtrans_order_id) }}</td>
                    </tr>
                    <tr>
                        <th><i class="fas fa-star icon"></i>Transaction ID</th>
                        <td>{{ ucfirst($status->paymentTransaction->midtrans_transaction_id) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <tr>
                        <th><i class="fas fa-star icon"></i>Waktu Transaksi</th>
                        <td>{{ ucfirst($status->paymentTransaction->transaction_time) }}</td>
                    </tr>
            ...
            <div class="alert alert-info mt-4" role="alert">
                <i class="fas fa-info-circle"></i> Invoice ini dibuat otomatis oleh sistem. Simpan sebagai bukti
                pembayaran.
            </div>
